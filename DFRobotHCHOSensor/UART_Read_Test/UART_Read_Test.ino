...
#define SensorSerialRxPin	10	//this pin read the uart signal from the HCHO sensor
#define SensorSerialTxPin	11	

SoftwareSerial sensorSerial(SensorSerialRxPin,SensorSerialTxPin);
